 ...
 * or FITNESS FOR A PARTICULAR PURPOSE. See the license item_files for details.
 *
...
(/** @lends <global> */function( $ ) {
	 ...
	 * At the same time these functions are often useful over multiple item_files in the
	 ...
	 * with older language item_files.
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 * the example language item_files to see how this works in action.
			 *  @type string
