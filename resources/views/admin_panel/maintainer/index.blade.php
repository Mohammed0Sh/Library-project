                ...
                <div class="table-data__tool-right">
                    <a href="{{route('maintainer.create')}}">
                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                            <i class="zmdi zmdi-plus"></i>إضافة مشرف جديد</button>
                    </a>
        ...
        <div class="table-responsive table--no-card m-b-30">
            <table id="table" class="table table-borderless table-striped table-earning">
                ...
                @foreach($maintainers as $maintainer)
                    <tr>
                        <td class="text-center">{{$maintainer->id}}</td>
                        <td class="text-center">{{$maintainer->first_name}}</td>
                        <td class="text-center">{{$maintainer->last_name}}</td>
                        <td class="text-center">{{$maintainer->mobile}}</td>
                        <td class="text-center">{{$maintainer->email}}</td>

                        <td class="text-center">
                            <div class="table-data-feature">
                                <a href="{{route('maintainer.edit',$maintainer->id)}}">
