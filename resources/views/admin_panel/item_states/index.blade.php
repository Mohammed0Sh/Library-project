...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="title-5 m-b-35">إدارة حالات العناصر</h3>

            <div class="table-data__tool">

                <div class="table-data__tool-right">
                    <a href="{{route('item_state.create')}}">
                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                            <i class="zmdi zmdi-plus"></i>إضافة حالة عنصر جديدة</button>
                    </a>
    ...
    <div class="col-lg-12">
        <div class="table-responsive table--no-card m-b-30">
            <table id="table" class="table table-borderless table-striped table-earning">
                ...
                <tr>
                    <td class="text-center">{{$item_state->id}}</td>
                    <td class="text-center">{{$item_state->name}}</td>
                    <td class="text-center">
                        <div class="table-data-feature">
                            <a href="{{route('item_state.edit',$item_state->id)}}">
