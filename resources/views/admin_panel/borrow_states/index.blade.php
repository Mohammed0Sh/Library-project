        ...
        <div class="col-md-12">
            ...
            <div class="table-data__tool">
                ...
                <div class="table-data__tool-right">
                    <a href="{{route('borrow_state.create')}}">
                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                            <i class="zmdi zmdi-plus"></i>
                            إضافة حالة استعارة جديدة
                        </button>
                    </a>
        ...
        <div class="table-responsive table--no-card m-b-30">
            <table id="table" class="table table-borderless table-striped table-earning">
                ...
                <tr>
                    ...
                    <th class="text-center">Borrow State Name</th>
                ...
                <tbody>
                @foreach($borrow_states as $borrow_state)
                <tr>
                    <td class="text-center">{{$borrow_state->id}}</td>
                    <td class="text-center">{{$borrow_state->name}}</td>
                    <td class="text-center">
                        <div class="table-data-feature">
                            <a href="{{route('borrow_state.edit',$borrow_state->id)}}">
