...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="title-5 m-b-35">إدارة أنواع العناصر</h3>

            <div class="table-data__tool">

                <div class="table-data__tool-right">
                    <a href="{{route('item_type.create')}}">
                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                            <i class="zmdi zmdi-plus"></i>إضافة نوع عنصر جديد</button>
                    </a>
        ...
        <div class="table-responsive table--no-card m-b-30">
            <table id="table" class="table table-borderless table-striped table-earning">
                ...
                @foreach($item_types as $item_type)
                    <tr>
                        <td class="text-center">{{$item_type->id}}</td>
                        <td class="text-center">{{$item_type->name}}</td>
                        <td class="text-center">
                            <div class="table-data-feature">
                                <a href="{{route('item_type.edit',$item_type->id)}}">
