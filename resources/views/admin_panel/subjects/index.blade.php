...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="title-5 m-b-35">    كل المواد الدراسية
            </h3>
                ...
                <div class="table-data__tool-right">
                    <a href="{{route('subject.create')}}">
                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                            <i class="zmdi zmdi-plus"></i>إضافة مادة دراسية جديدة</button>
                    </a>
        ...
        <div class="table-responsive table--no-card m-b-30">
            <table id="table" class="table table-borderless table-striped table-earning">
                ...
                <tr>
                    ...
                    <th class="text-center">Specialize</th>
                ...
                @foreach($subjects as $subject)
                    <tr>
                        ...
                        <td class="text-center">{{$subject->getSpecialize->name}}</td>
                        <td class="text-center">{{$subject->getAcademic_Year->name}}</td>
